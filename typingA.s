...
begin_program:
    puts str_prompt1            # print intial prompts
    puts str_prompt2
    ...
    puts str_prompt3            # print incorrect number prompt
    ...
    lb $10, newline             # print a new line after integer
    putc $10
    ...
    puts str_prompt4            # prompt user to test again

    getc $8
    li $9, 121                  # load ascii character 'y' to test against
    lb $10, newline             
    putc $10                    # print new line after response
